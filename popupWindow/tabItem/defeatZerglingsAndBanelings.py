"""map: defeat zerglings and banelings
@author: cjing9017
@date: 2019/05/25
"""
...
class DefeatZerglingsAndBanelings(QWidget):

    def __init__(self):
        super(DefeatZerglingsAndBanelings, self).__init__()
        self.setObjectName('DefeatZerglingsAndBanelings')
    ...
    def insert_html(self):
        f = QFile("./../resource/html/defeatZerglingsAndBanelings.html")
